...
public class MyRestaurant extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MyRestaurant.this, "Welcome " + user_name ,Toast.LENGTH_LONG ).show();
     ...
     //   custinfo=(Button)findViewById(R.id.custinfo);
        ...
        info.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i =new Intent(MyRestaurant.this,InfoScreen.class);
				MyRestaurant.this.startActivity(i);
			}
		});
        go_to_menu.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//starting new activity on button click
				Intent i =new Intent(MyRestaurant.this,MenuScreen.class);
				MyRestaurant.this.startActivity(i);
			}
		});
        ...
        findstore.setOnClickListener( new OnClickListener() {
			...
			public void onClick(View v) {
				//starting new activity on button click
				Intent i =new Intent(MyRestaurant.this,FindStore.class);
				MyRestaurant.this.startActivity(i);
			}
		});
        go_to_order_list.setOnClickListener( new OnClickListener() {
			...
			public void onClick(View v) {
				//starting new activity on button click
				Intent i =new Intent(MyRestaurant.this,OrderList.class);
				MyRestaurant.this.startActivity(i);
			}
		});
     /*   custinfo.setOnClickListener( new OnClickListener() {
			...
			public void onClick(View v) {
				//starting new activity on button click
				Intent i =new Intent(MyRestaurant.this,custinfo.class);
				MyRestaurant.this.startActivity(i);
			}
		});*/
    }
