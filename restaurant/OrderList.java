...
public class OrderList extends Activity {
	 ...
	 public void onCreate(Bundle savedInstanceState) {
	      ...
	      adapter=new ArrayAdapter<String>(OrderList.this,
	        ...
	        {
	        	Toast.makeText(this, "No order is placed yet. Please go to menu section and add order.", Toast.LENGTH_LONG).show();
	      ...
	      placedorder.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try{
					...
					HttpPost postMethod=new HttpPost("http://10.0.2.2/restaurantdb/data_store.php");
					...
					String message="Data Enter Successfully!";
